...
public class Playlist_RevTue implements Comparable<Playlist_RevTue> {
    ...
    public void sortPlaylists(ArrayList<Playlist_RevTue> allPlaylists){
        Collections.sort(allPlaylists,Collections.reverseOrder());
    }
    public int compareTo (Playlist_RevTue playlist){
        return Integer.compare(songs.size(),playlist.songs.size());
    }
